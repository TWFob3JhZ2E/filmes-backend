...
# Criação da pasta temp se não existir
TEMP_DIR = 'temp'
...
CODE_FILMES_NOMES_PATH = os.path.join(TEMP_DIR, 'CodeFilmesNomes.json')
...
def buscar_nomes():
    ...
    filmes = carregar_dados_json(CODE_FILMES_NOMES_PATH)
